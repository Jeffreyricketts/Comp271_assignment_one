...
public class QuickSortPriorityQueueTest {
    ...
    public void getsMinimum() {
        System.out.println("Calculating runtime for Quick Sort:");
        PriorityQueue priorityQueue = new QuickSortPriorityQueue(52,2,6,1,5,51,7,8,9,10,21,22,23,24,25,26,27,28,29,
